program example
    ...
    real(real64), parameter :: mu_s = 0.25d0
    real(real64), parameter :: vs = 0.1d0
    real(real64), parameter :: bv = 0.0d0
    real(real64), parameter :: k = 1.0d4
    ...
    mdl%coulomb_friction_coefficient = mu
    mdl%static_friction_coefficient = mu_s
    ...
    call yAxis%set_limits(-1.5d0 * mu_s * Fnrm, 1.5d0 * mu_s * Fnrm)
